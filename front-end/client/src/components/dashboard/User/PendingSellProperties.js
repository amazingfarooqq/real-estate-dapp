...
export const PendingSellProperties = ({ owners }) => {
  const { active, account, requestsSellPropertyObject, fetchDataFunction } =
    useAuth();
  ...
  return (
    <>
      <div className="row">
        {active ? (
          <>
            {requestsSellPropertyObject && requestsSellPropertyObject == 0 ? (
              // LOADER ====//
                    ...
                    return (
                      ...
                      {/* PROPERTIES =========///==== */}
                        ...
                        {data.CurrentOwner === account && (
                           ...
                           componentAsProp={<button className="disabled btn btn-success mx-1">Pending sell request</button>}/>  
                      ...
                      //                <button className="disabled btn btn-success mx-1">Pending sell request</button>
