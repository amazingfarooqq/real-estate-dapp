                    ...
                    <div className="col-12 mt-5">
                        ...
                        <div className="row justify-content-center">
                            ...
                            <div className="col-11 col-lg-4 p-4">
                                <img className='w-100' style={{height: '250px'}} src="https://santastellarealestate.com/wp-content/uploads/2014/03/buy550.jpg" alt="img" />
                            ...
                            <div className="col-11 col-lg-4 p-4">
                                <img className='w-100' style={{height: '250px'}} src="https://img.gtsstatic.net/reno/imagereader.aspx?imageurl=https%3A%2F%2Fsir.azureedge.net%2F1289i215%2Fe0r1htzgy95h4mt6pxv6hr2ev6i215&option=N&h=472&permitphotoenlargement=false" alt="img" />
                            ...
                            <div className="col-11 col-lg-4 p-4">
                                <img className='w-100' style={{height: '250px'}} src="https://i.pinimg.com/736x/99/a1/03/99a1035bedbdf973a1b0add371570d83.jpg" alt="img" />
